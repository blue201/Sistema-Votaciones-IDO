...
<a href='#' data-toggle="modal" data-target="#createCargo" class="btn btn-info">
    <i class="fas fa-plus-circle"></i> <strong >Nueva Jornada</strong>
</a>
            ...
            <form method="post" action="">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label style="float: left;width: 20%" for="delito" class="col-form-label">Jornada:</label>
                        <input style="float: left;width: 80%" required type="text" class="form-control form-control-user" maxlength="150" name="descripcion"
                            id="descripcion" placeholder="Ingrese el nombre de la jornada" onkeyup="validar()">
