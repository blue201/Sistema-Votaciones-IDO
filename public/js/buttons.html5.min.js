...
new Blob([a],{type:"application/pdf"});q(a,x(c))})},title:"*"+fecha.getDate()+"/"+(fecha.getMonth()+1)+"/"+fecha.getFullYear(),filename:"*"+fecha.getDate()+"_"+(fecha.getMonth()+1)+"_"+fecha.getFullYear(),extension:".pdf",exportOptions:{columns: [0,1,2,3,4]},orientation:"portrait",pageSize:"A4",header:!0,footer:!1,message:null,customize:null,download:"download"};return r.Buttons});